...
//        System.out.println("Hello, World!");
        String news="PITTSBURGH (AP) — Carnegie Mellon University will hire a researcher from the Library of Congress to help it decode a collection that includes two WWII German Enigma machines.\n" +
        ...
        System.out.println("一共有"+wordsSet.size()+"个单词");
